    ...
    <div className="container flex justify-center items-center">
      ...
      <div className="md:w-[45%] border border-gray-200 shadow-lg rounded-md mt-6">
        ...
        <div className=" px-6 py-0">
          ...
          <div className="mb-4 mt-4 border rounded-md shadow-md border-gray-200 px-3 py-3 font-poppins">
          ...
          {userInfo &&
            ...
            !order.isDelivered && (
              <div>
                <button
                  type="button"
                  className="bg-pink-500 text-white w-full py-2 mb-6 mt-4 rounded-md"
          ...
          {order.isDelivered && (
            <div className=" mt-6 font-poppins font-medium text-[13px] text-center mb-6 ">
